...
<body class="main-layout">
                        ...
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <!--<li> <a href="../index.php">Login</a> </li>-->
							         <li class="active"> <a href="noticias.php">Administrar Noticias</a> </li>
							         <li> <a href="login/admin/admin_portada.php">Administrar Usuarios</a> </li>
      ...
      <div class="brand_color1">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <center><h2>Insertar Noticias</h2></center>
                    </div>
                </div>
            </div>
        </div>
...
<?php include('insertar_modelo.php'); ?>
